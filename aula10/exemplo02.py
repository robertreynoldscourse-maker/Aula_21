...
# Calculando a Assimetría
try:
    # Assimetria
    # Medida que indica como os dados estão distribuidos em torno do valor central
    # Estão distribuidos em torno do Centro?
    # Existe uma qtd maior de registros maiores ou menores?
    # Para que lado está o peso.
    # É a medida usada para descrever o grau de simetría ou assimetría

    #   INTERPRETAÇÃO:
    # Assimetría > 1: Positiva Alta
    # Valores Altos puxando a média para cima.
    # A média tende a ser maior que a mediana.

    # Assimetría entre 0.5 e 1: Positiva Moderada
    # A cauda à direita, mas é menos acentuada

    # Assimetría entre -0.5 e 0.5: Distribuição aproximadamente simétrica
    # Tendência de dados equilibrados
    # A média, a mediana, e a moda tenha valores próximos

    # Assimetría entre -0.5 e -1: Negativa Moderada
    # Há cauda à esquerda, mas é menos acentuada

    # Assimetría < -1: Negativa Alta
    ...
    # Curtose
    # Descrevendo o formato da distribuição
...
try:
    ...
    #POSIÇÂO 4 - MEDIDAS ESTATÍSTICAS
    plt.subplot(2, 2, 4) 
